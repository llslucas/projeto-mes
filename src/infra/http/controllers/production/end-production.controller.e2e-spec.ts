...
describe("End production (E2E)", () => {
  ...
  test("[POST] /machines/:machineId/end-production", async () => {
    ...
    const response = await request(app.getHttpServer())
      .post(`/production/machines/${machine.id.toString()}/end-production`)
    ...
    expect(reportOnDatabase.type).toBe("Production end");
  });
});
